...
TEST_CASE("Camera Culling - Object Visibility Tests")
{
  ...
  SECTION("Object Outside Frustum")
  {
    ...
    // FIXED: Object behind camera should NOT be visible
    // This enforces correct culling behavior instead of accommodating broken fallback frustum
    REQUIRE(isVisible == false); // Object behind camera should NOT be visible
