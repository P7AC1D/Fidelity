...
public:
  ...
  Vector3 getForward() const { return Vector3::Normalize(Vector3(_transform[0][2], _transform[1][2], _transform[2][2])); }
  Vector3 getUp() const { return Vector3::Normalize(Vector3(_transform[0][1], _transform[1][1], _transform[2][1])); }
